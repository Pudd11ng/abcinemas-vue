Daniel Teng, [14/6/2024 11:31 PM]
<template>
  <div id="home">
    <HeaderPage />
    <div class="w3l-breadcrumbs">
      <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
          <a href="homepage.vue">Home</a> » <span class="breadcrumb_last" aria-current="page">movies</span>
        </div>
      </nav>
    </div>
    <!--/movies -->
          ...
          <div class="owl-four owl-carousel owl-theme">
            <div class="item vhny-grid">
              <div class="box16">
                <a href="#">
                  <figure>
                    <img class="img-fluid" src="assets/garfieldmovie.jpeg" alt="" />
                  </figure>
                  <div class="box-content">
                    <h3 class="title">The New Garfield Movie 2024</h3>
              ...
              <div class="box16 mt-4">
                <a href="#">
                  <figure>
                    <img class="img-fluid" src="assets/furiosa.jpeg" alt="" />
                  </figure>
                  <div class="box-content">
                    <h3 class="title">Furiosa: A Mad Max Saga</h3>
            ...
            <div class="item vhny-grid">
              <div class="box16">
                <a href="#">
                  <figure>
                    <img class="img-fluid" src="assets/kingdomoftheplanetapes.jpeg" alt="" />
                  </figure>
                  <div class="box-content">
                    <h3 class="title">Kingdom of the Planet Apes</h3>
                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
              ...
              <div class="box16 mt-4">
                <a href="#">
                  <figure>
                    <img class="img-fluid" src="assets/howtomakemillions.jpeg" alt="">
                  </figure>
                  <div class="box-content">
                    <h3 class="title">How to Make Millions Before Grandma Dies</h3>
                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
            ...
            <div class="item vhny-grid">
              <div class="box16">
                <a href="#">
                  <figure>
                    <img class="img-fluid" src="assets/thefallguy.jpeg" alt="">

                  </figure>
                  <div class="box-content">
                    <h3 class="title">The Fall Guy</h3>
                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 5min
          ...
          <div class="headerhny-title">
            <div class="w3l-title-grids">
              ...
              <div class="headerhny-right text-lg-right">
                <h4><a class="show-title" href="movies.vue">Show all</a></h4>
              </div>
            </div>
          </div>
          <div class="w3l-populohny-grids">
            <div class="item vhny-grid">
              <div class="box16 mb-0">
                ...
                <a href=".GarfieldMovie" data-toggle="modal">
                  <div class="box-content">
                    <h3 class="title">The New Garfield Movie</h3>
                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 41min
...
<span class="post fa fa-heart text-right"></span>
                ...
                <!-- Modal -->
                <div class="modal fade GarfieldMovie" id="myModal" tabindex="-1" role="dialog"
                  aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content" id="mymodalcontent">
                      ...
                      <div class="modal-body" id="dynamic-content">
                        <img src="assets/garfieldmovie.jpeg" class="img-fluid modalimg"
                          alt="" />
                        <h3>Release Date: 24 May 2024</h3>
                        <h3>Venue: Cg Road</h3>
                        <h4>About Movie</h4>
                        <p>
                          The Garfield Movie is a 2024 American animated adventure comedy film
                          based on the
                          comic strip Garfield created by Jim Davis. Directed by Mark Dindal
                          from a
                          screenplay by Paul A. Kaplan, Mark Torgove, and David Reynolds, the
                          film stars Chris Pratt as the voice of the titular character,
                          alongside
                          the voices of Samuel L. Jackson, Hannah Waddingham, Ving Rhames,
                          Nicholas Hoult,
                          Cecily Strong, Harvey Guillén, Brett Goldstein, Bowen Yang, and
                          Snoop Dogg.
                          In the film, Garfield is reunited with his long-lost father, a
                          street cat named
                          Vic, being forced into joining him on a high-stakes adventure.
                        </p>
                        <h4>Star Cast</h4>
                        <p>
                          Chris Pratt as Garfield <br />
                          Samuel L. Jackson as Vic<br />
                          Hannah Vaddignham as Vinx<br />
                          Ving Rhames as Otto<br />
                        </p>
                      </div>
                      <div class="bookbtn">
...
<span class="fa fa-play video-icon"
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/n3.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Free Guy</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                ...
                <div class="albums-content">
                  <div class="row">
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m1.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Rocketman</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m2.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Doctor Sleep</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
...
<span class="post fa fa-heart text-right"></span>
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m3.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Knives Out</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m7.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Frozen 2</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m8.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Toy Story 4</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m9.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
...
<span class="fa fa-play video-icon"
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Joker</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
...
<span class="post fa fa-heart text-right"></span>
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m10.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">Alita</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                            </span>
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m11.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">The Lego</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
                            </span>
                    ...
                    <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                      <div class="slider-info">
                        <div class="img-circle">
                          <a href="movies.vue"><img src="assets/images/m12.jpg"
                              class="img-fluid" alt="author image">
                            <div class="overlay-icon">
                        ...
                        <div class="message">
                          <p>English</p>
                          <a class="author-book-title" href="movies.vue">The Hustle</a>
                          <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr
                              4min
