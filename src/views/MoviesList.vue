    ...
    <div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="homepage.html">Home</a> » <span class="breadcrumb_last" aria-current="page">movies</span>
			</div>
		</nav>
	</div>
	<!--/movies -->
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="assets/garfieldmovie.jpeg" class="img-fluid modalimg" alt="" />
											<p>
											...
											<h4>About Movie</h4>
											<p>
												The Garfield Movie is a 2024 American animated adventure comedy film based on the 
												comic strip Garfield created by Jim Davis. Directed by Mark Dindal from a 
												screenplay by Paul A. Kaplan, Mark Torgove, and David Reynolds, the 
												film stars Chris Pratt as the voice of the titular character, alongside 
												the voices of Samuel L. Jackson, Hannah Waddingham, Ving Rhames, Nicholas Hoult, 
												Cecily Strong, Harvey Guillén, Brett Goldstein, Bowen Yang, and Snoop Dogg. 
												In the film, Garfield is reunited with his long-lost father, a street cat named
